...
public:
     ...
     * @param seed_for_key_gen Per-character multiplier mixed into each generated byte;
     *        NOT the sole RNG seed (the generator itself is seeded from OS entropy
     *        via std::random_device, so distinct calls always produce distinct keys).
